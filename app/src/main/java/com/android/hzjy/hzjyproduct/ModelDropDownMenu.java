...
public class ModelDropDownMenu extends RelativeLayout {
    ...
    public ModelDropDownMenu(Context context) {
        this(context,null);
    }

    public ModelDropDownMenu(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ModelDropDownMenu(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttr(@Nullable AttributeSet attrs){
        TypedArray array = mContext.obtainStyledAttributes(attrs,R.styleable.ModelDropDownMenu);
        mMaskViewColor = array.getColor(R.styleable.ModelDropDownMenu_mask_view_color, mMaskViewColor);
        mDurationTime = array.getInteger(R.styleable.ModelDropDownMenu_duration,mDurationTime);
        array.recycle();
    }
...
//        viewMask.setBackgroundColor(mMaskViewColor);
        viewMask.setBackgroundColor(Color.argb(0,0,0,100));
        //添加view
        addView(viewMask);
        //默认是隐藏的
