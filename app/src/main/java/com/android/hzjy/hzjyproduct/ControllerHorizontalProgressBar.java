...
//public class ControllerHorizontalProgressBar extends ProgressBar
...
public class ControllerHorizontalProgressBar extends View {
    ...
    private float mProgressBgHeight = 60;
    private float mProgressHeight = 50;
...
//        endX = getWidth() / 2;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float mm = (startX + 1 - currentX) / (startX - endX);
        //绘制的文本
        String text = mm + "%";
//
//        //拿到字体的宽度和高度
